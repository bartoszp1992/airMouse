...
int main(void) {
	...
	espat_state_t espStat = espAt_init(&bleRadio, &huart1, 50, 1500);
...
//			amz *= -1;
			...
			mouseButtonState = 0;
			mouseButtonState = !HAL_GPIO_ReadPin(MUS_LB_GPIO_Port, MUS_LB_Pin)
					<< 0 | !HAL_GPIO_ReadPin(MUS_RB_GPIO_Port, MUS_RB_Pin) << 1
			...
			espAt_sendParams(&bleRadio, P_BHM, 4, mouseButtonState, amx, amz,
					0);
