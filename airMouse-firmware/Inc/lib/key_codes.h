...
#ifndef LIB_KEY_CODES_H_
#define LIB_KEY_CODES_H_

//internal
#define HID_INTERNAL_FN				0xff
#define HID_INTERNAL_DPI			0xfe
#define HID_INTERNAL_PRC			0xfd
#define HID_INTERNAL_HOME			0xfc
...
#define HID_MOUSE_WHEELUP			1
#define HID_MOUSE_WHEELDN			-1
